...
// Fetch data
$query = "SELECT codeBook, titleBook, category, totalReceive, comment, dateReceive FROM bookn9";
$result = $conn->query($query);

// HTML untuk PDF
$html = '<h2>Senarai Buku Negeri Sembilan</h2>
